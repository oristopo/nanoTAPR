...
*Note*: A `hardware rework` to the buffer
amplifier U8 is needed on most units. The value of R19 is changed from
24.7 ohms to 12 ohms, and a 1500 ohm resistor is added to pull up the
base. This reduces the amount of distortion generated by U8. A
...
120.0 DPI rather than the Windows standard 96.0 DPI resolution.
